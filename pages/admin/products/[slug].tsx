...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const onFilesSelected = async ( { target }: ChangeEvent<HTMLInputElement> ) => {
        ...
        const listaArchivos: any = target.files;
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        ...
                        <TextField
                            ...
                            { ...register('inStock', {
                                required: 'Este campo es requerido',
                                min: { value: 0, message: 'Mínimo de valor es cero' }
                            })}
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        <TextField
                            ...
                            { ...register('slug', {
                                required: 'Este campo es requerido',
                                validate: (val) => val.trim().includes(' ') ? 'No se puede tener espacion en blanco': undefined
                            })}
                            error={ !!errors.slug }
